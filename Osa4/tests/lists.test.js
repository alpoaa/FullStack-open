...
describe('total like tests', () => {
    test('Test of total likes with one blog list', () => {
        const result = listHelper.totalLikes(oneBlogList)
        expect(result).toBe(5)
    })

    test('Test with multiple blogs in list', () => {
...
describe('most likes tests', () => {
    test('author with most likes with multiple blog list', () => {
